...
This is a tutorial that outlines the implementation of on-premises Active Directory (Windows) within Microsoft Azure Virtual Machines (VM).<br />
...
<p>
5.  <b> CONGRATULATIONS!!! You have now installed and configured AD, created a domain, created OUs, and created a ton of user accounts. Feel free to play around with all the possibilities of AD. Also, explore other functions and concepts to further your knowledge like Group Policy and Powershell Scripting!</b>
</p>
